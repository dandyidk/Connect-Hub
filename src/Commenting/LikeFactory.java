...
public class LikeFactory implements FILELOCATION {
    ...
    public boolean buildLike(String id, ContentMedia post) {
        ...
        for (Like like : likes.values()) {
            if ((like.getAuthorId().compareTo(post.getUserId()) == 0)
                    && (like.getContentId().compareTo(post.getContentId()) == 0)
                    && (like.getUserId().compareTo(id) == 0)) {
                ...
                try {
                    ...
                    for (int i = 0; i < temparray.size(); i++) {
                        ...
                        if (((String) object.get("Like Id")).compareTo(like.getId()) == 0) {
                            temparray.remove(i);
